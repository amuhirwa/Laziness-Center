    ...
    <div>
      ...
      {items.length === 0 ? (
        ...
        <div className="space-y-px">
          <div className="hidden sm:grid grid-cols-[1fr_auto_auto_auto] gap-4 px-4 py-2 text-xs text-neutral-500 uppercase tracking-wide border-b border-neutral-200 dark:border-neutral-800">
            <span>Item</span>
          ...
          {items.map((item) => (
            <div
              ...
              className="grid grid-cols-1 sm:grid-cols-[1fr_auto_auto_auto] gap-1 sm:gap-4 items-center
                         px-4 py-3 border-b border-neutral-200 dark:border-neutral-800 hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-colors"
            >
              ...
              <span className="text-xs text-neutral-500 text-right sm:w-28">
